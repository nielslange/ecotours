...
// Hide Jetpack notifications
add_filter( 'jetpack_just_in_time_msgs', '__return_false' );

// Hide WooCommecre notifications
...
function sp_footer_creds_filter( $creds ) {
	...
	$creds .= 'Developed with <abbr title="March 7, 2019 &middot; Jakarta, Indonesia" style="color:#677a4f;"><i class="fa fa-heart"></i></abbr> ';
